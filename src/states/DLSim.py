...
class Simulation(State):
    ...
    def __init__(self):
        ...
        self.agent.add_layer(Recurrent(100, input_shape=self.environment.num_features))
        self.agent.add_layer(Activation('relu'))
        self.agent.add_layer(Recurrent(100, input_shape=self.environment.num_features))
        self.agent.add_layer(Activation('relu'))
        self.agent.add_layer(Recurrent(2, input_shape=self.environment.num_features))
    ...
    def on_update(self, elapsed):
        ...
        # print(self.environment.trainX.shape)
        # print(self.environment.trainy.shape)
