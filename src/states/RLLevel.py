...
class RLLevelState(State):
    " A "

    def __init__(self):
        super().__init__("RLLevel", "MasterState")
        ...
        self.game_surf = pygame.Surface((300, 300))
        o = 5
        self.elements.append(RoundedButton(1360-o, 140 + self.game_surf.get_height(), 70, 70, 3, config.BLACK, config.SCHEME2, self.play))
        self.elements.append(RoundedButton(1280-o, 140 + self.game_surf.get_height(), 70, 70, 3, config.BLACK, config.SCHEME2, lambda: print("Stop")))
        self.elements.append(Image(1300-o, 160 + self.game_surf.get_height(), 30, 30, "data/assets/stop.png"))
        self.elements.append(RoundedButton(1200-o, 140 + self.game_surf.get_height(), 70, 70, 3, config.BLACK, config.SCHEME2, self.pause))
        self.elements.append(Image(1220-o, 160 + self.game_surf.get_height(), 30, 30, "data/assets/pause.png"))
        self.elements.append(RoundedButton(1120-o, 140 + self.game_surf.get_height(), 70, 70, 3, config.BLACK, config.SCHEME2, self.play))
        self.elements.append(Image(1140-o, 160 + self.game_surf.get_height(), 30, 30, "data/assets/play.png"))
    ...
    def on_render(self, screen):
        ...
        pygame.draw.rect(screen, config.BLACK, (config.SCREEN_WIDTH - self.game_surf.get_width() - 30, 110, self.game_surf.get_width() + 20, self.game_surf.get_width() + 20))
        self.game_surf.fill(config.SCHEME2)
        screen.blit(self.game_surf, (config.SCREEN_WIDTH - self.game_surf.get_width() - 20, 120))
    ...
    def load_level(self, level_num):
        level_num -= config.NUM_SUP_LEVELS
